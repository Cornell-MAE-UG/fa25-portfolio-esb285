...
![Hand-calculation Diagrams]({{ "/assets/images/actual_images_used/IMG_2755.jpeg" | relative_url }}){: style="width: 500px"}
...
![Hand-calculation Diagrams]({{ "/assets/images/actual_images_used/IMG_2330.JPG" | relative_url }}){: style="width: 500px"}
...
![Hand-calculation Diagrams]({{ "/assets/images/actual_images_used/IMG_2331.JPG" | relative_url }}){: style="width: 500px"}
...
![Hand-calculation Diagrams]({{ "/assets/images/actual_images_used/IMG_2332.JPG" | relative_url }}){: style="width: 500px"}
...
The design of this heat exchanger is also interesting. This was made so that two fluids end up at different pipes as shown from the cut up section of the heat exchanger shown below.
